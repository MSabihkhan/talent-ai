...
import { Eye, EyeOff, Briefcase, Building2, CheckCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'var(--bg-primary)' }}>
      ...
      <div 
        ...
        style={{ 
          background: 'linear-gradient(135deg, rgba(108, 99, 255, 0.15), var(--bg-primary))',
        }}
      >
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2 mb-8">
            <span className="font-bold text-2xl" style={{ fontFamily: 'var(--font-display)', color: 'var(--text-primary)' }}>
              TalentAI
            </span>
          </Link>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <button
                  ...
                  style={{
                    background: selectedRole === role.value ? 'rgba(108, 99, 255, 0.08)' : 'var(--bg-secondary)',
                ...
                >
                  {selectedRole === role.value && (
                    <div 
                      ...
                      style={{ background: 'var(--accent-primary)' }}
                    >
                      <CheckCircle className="w-3 h-3" style={{ color: 'var(--text-primary)' }} />
                    </div>
                  )}
                  <role.icon 
          ...
          <form className="space-y-6">
            ...
            <button
              type="button"
              className="w-full py-3.5 rounded-xl transition-all duration-150 active:scale-[0.97] flex items-center justify-center gap-3"
              style={{
