    ...
    <div className="min-h-screen mesh-gradient" style={{ background: 'var(--bg-primary)' }}>
      ...
      <nav className="relative z-10 px-6 py-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8" style={{ color: 'var(--text-primary)' }}>
      ...
      <section className="relative z-10 px-6 py-20 md:py-32">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <div 
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-8 text-xs uppercase tracking-wider"
              style={{ 
          ...
          >
            Find Work That Fits,<br />Not Just Pays.
          </motion.h1>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div 
            className="text-xs uppercase tracking-widest mb-12 text-center text-gradient-secondary"
          >
            How It Works
          </div>
