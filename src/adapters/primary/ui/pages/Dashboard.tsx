...
import { Home, User, FileText, Search, ClipboardList, MessageSquare, Bell, Settings, Upload, TrendingUp, Briefcase, MapPin, Clock, ArrowUpRight, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen flex" style={{ background: 'var(--bg-primary)' }}>
      ...
      >
        ...
        <div className="p-3">
          <Link
            to="/"
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-150 text-left hover:opacity-80"
